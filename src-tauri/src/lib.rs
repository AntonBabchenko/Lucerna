...
pub fn specta_builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            commands::list_orphaned_backup_worlds,
            commands::list_stranded_worlds,
            commands::recover_stranded_world,
            ...
            commands::rename_instance_dir,
            commands::preview_instance_dir_name,
            commands::instance_path_status,
